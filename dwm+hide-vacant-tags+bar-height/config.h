...
static const char *fonts[] = { "SF Pro Display:style=Medium:size=10", "Font Awesome 5 Free Solid:size=12" };
...
//static const char col_cyan[]        = "#114488";

// blue
//static const char col_gray1[]       = "#114488";
...
static const char *const autostart[] = {
	"sh", "c", "~/.local/share/autostart.sh", NULL,
	NULL /* terminate */
};
...
/* powermenu */
static const char *powermenu[] = { "/home/freebsd/.scripts/powermenu.sh", NULL };
...
//	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
    ...
    { MODKEY, XK_p, spawn, SHCMD("~/.screenlayout/external-monitor.sh") },
    { MODKEY|ShiftMask, XK_p, spawn, SHCMD("~/.screenlayout/default-monitor.sh") },
    ...
    // Background 
    { MODKEY, XK_z,      spawn,        SHCMD("feh --bg-fill ~/dot_files/.config/wallpaper.jpg") },
